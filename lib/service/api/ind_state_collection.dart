class IndStateCollection {
 static const List<Map<String, dynamic>> states = [
    ...
    {"state_id": 32, "state_name": "Lakshadweep"},
    {"state_id": 33, "state_name": "Delhi"},
    {"state_id": 34, "state_name": "Puducherry"},
    {"state_id": 35, "state_name": "Ladakh"},
    {"state_id": 36, "state_name": "Jammu and Kashmir"},
  ];
}